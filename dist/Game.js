...
export class Game {
    ...
    player1Username;
    player2Username;
    constructor(player1, player2, timeControl = 600, player1Username = "Player1", player2Username = "Player2") {
        ...
        // start the timer 
        this.startTimer();
        console.log(`Game created: ${this.player1Username} (white) vs ${this.player2Username} (black)`);
    }
    // START TIMER 
    startTimer() {
